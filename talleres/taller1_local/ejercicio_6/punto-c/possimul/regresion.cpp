...
void InicieAnimacion(void){
  ...
  cout<<"set output 'regresion(seed1R).pdf'"<<endl;
  cout<<"unset key"<<endl;
...
//-----------  Programa Principal --------------
int main(){
  ifstream fin("f_piladearena(seed1R).txt");
  int N;fin>> N;
  ...
  DibujePerfil(76.7353,
	       0.39488136475407093 ,1.1990962365847417,
	       -0.3434980440273739,59.635550985814035);
  TermineCuadro();
