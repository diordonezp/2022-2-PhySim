...
int main(){
  ...
  std::cout<<"valores de lambda deseados:"<<"\n";
  std::cout<<cerosporbis(2,3,1)<<"\n";
  std::cout<<cerosporbis(5,6,1)<<"\n";
  std::cout<<cerosporbis(8,9,1)<<"\n";
  std::cout<<cerosporbis(11,12,1)<<"\n";
  std::cout<<cerosporbis(14,15,1)<<"\n";
